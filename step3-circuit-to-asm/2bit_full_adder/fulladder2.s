...
.Lfunc_begin0:
	.file	0 "/u/uab9qt/worktable/llvm_repos/bit-serial-compiler/step3-circuit-to-asm/2bit_full_adder" "fulladder2.c" md5 0x55a08186caad8a31f12c9d52378e956f
	.loc	0 13 0                          # fulladder2.c:13:0
	.cfi_sections .debug_frame
	.cfi_startproc
# %bb.0:
	#DEBUG_VALUE: fullAdder2:pi0_p <- $x10
	#DEBUG_VALUE: fullAdder2:pi1_p <- $x11
	#DEBUG_VALUE: fullAdder2:pi2_p <- $x12
	#DEBUG_VALUE: fullAdder2:pi3_p <- $x13
	#DEBUG_VALUE: fullAdder2:pi4_p <- $x14
	#DEBUG_VALUE: fullAdder2:po0_p <- $x15
	#DEBUG_VALUE: fullAdder2:po1_p <- $x16
	#DEBUG_VALUE: fullAdder2:po2_p <- $x17
	addi	sp, sp, -96
...
.Ltmp0:
	#DEBUG_VALUE: fullAdder2:po2_p <- [DW_OP_plus_uconst 36] [$x2+0]
	sw	a6, 32(sp)                      # 4-byte Folded Spill
.Ltmp1:
	#DEBUG_VALUE: fullAdder2:po1_p <- [DW_OP_plus_uconst 32] [$x2+0]
	sw	a5, 28(sp)                      # 4-byte Folded Spill
.Ltmp2:
	#DEBUG_VALUE: fullAdder2:po0_p <- [DW_OP_plus_uconst 28] [$x2+0]
	.loc	0 15 12 prologue_end            # fulladder2.c:15:12
	lw	t0, 0(a0)
.Ltmp3:
	#DEBUG_VALUE: fullAdder2:pi0 <- $x5
	.loc	0 0 12 is_stmt 0                # fulladder2.c:0:12
	sw	t0, 40(sp)                      # 4-byte Folded Spill
	.loc	0 15 26                         # fulladder2.c:15:26
	lw	a0, 0(a1)
.Ltmp4:
	#DEBUG_VALUE: fullAdder2:pi1 <- $x10
	.loc	0 0 26                          # fulladder2.c:0:26
	sw	a0, 20(sp)                      # 4-byte Folded Spill
.Ltmp5:
	#DEBUG_VALUE: fullAdder2:pi1 <- [DW_OP_plus_uconst 20] [$x2+0]
	#DEBUG_VALUE: fullAdder2:pi1 <- [DW_OP_plus_uconst 20] [$x2+0]
	.loc	0 15 40                         # fulladder2.c:15:40
	lw	t1, 0(a2)
.Ltmp6:
	#DEBUG_VALUE: fullAdder2:pi2 <- $x6
	.loc	0 15 68                         # fulladder2.c:15:68
	lw	t3, 0(a4)
.Ltmp7:
	#DEBUG_VALUE: fullAdder2:pi4 <- $x28
	.loc	0 15 54                         # fulladder2.c:15:54
	lw	a0, 0(a3)
.Ltmp8:
	#DEBUG_VALUE: fullAdder2:pi3 <- $x10
	.loc	0 0 54                          # fulladder2.c:0:54
	sw	a0, 16(sp)                      # 4-byte Folded Spill
.Ltmp9:
	#DEBUG_VALUE: fullAdder2:pi3 <- [DW_OP_plus_uconst 16] [$x2+0]
	#DEBUG_VALUE: fullAdder2:pi3 <- [DW_OP_plus_uconst 16] [$x2+0]
	.loc	0 18 2 is_stmt 1                # fulladder2.c:18:2
	#APP
	########## BEGIN ##########
	#NO_APP
	.loc	0 19 2                          # fulladder2.c:19:2
	#APP
	xor	t0, t1, t0
	not	t0, t0
	#NO_APP
.Ltmp10:
	#DEBUG_VALUE: fullAdder2:new_n9 <- $x5
	#DEBUG_VALUE: fullAdder2:pi0 <- [DW_OP_plus_uconst 40] [$x2+0]
	#DEBUG_VALUE: fullAdder2:pi0 <- $x5
	.loc	0 20 2                          # fulladder2.c:20:2
	#APP
	xor	t2, t0, t3
	not	t2, t2
	#NO_APP
.Ltmp11:
	#DEBUG_VALUE: fullAdder2:po0 <- $x7
	.loc	0 0 2 is_stmt 0                 # fulladder2.c:0:2
	sw	t2, 24(sp)                      # 4-byte Folded Spill
.Ltmp12:
	#DEBUG_VALUE: fullAdder2:po0 <- [DW_OP_plus_uconst 24] [$x2+0]
	#DEBUG_VALUE: fullAdder2:po0 <- [DW_OP_plus_uconst 24] [$x2+0]
	lw	t2, 40(sp)                      # 4-byte Folded Reload
.Ltmp13:
	#DEBUG_VALUE: fullAdder2:pi0 <- $x7
	.loc	0 21 2 is_stmt 1                # fulladder2.c:21:2
	#APP
	and	t1, t1, t2
	#NO_APP
.Ltmp14:
	#DEBUG_VALUE: fullAdder2:new_n11 <- $x6
	.loc	0 22 2                          # fulladder2.c:22:2
	#APP
	not	t1, t1
	#NO_APP
.Ltmp15:
	#DEBUG_VALUE: fullAdder2:new_n12 <- $x6
	.loc	0 23 2                          # fulladder2.c:23:2
	#APP
	not	t0, t0
	#NO_APP
.Ltmp16:
	#DEBUG_VALUE: fullAdder2:new_n13 <- $x5
	.loc	0 24 2                          # fulladder2.c:24:2
	#APP
	and	t0, t0, t3
	#NO_APP
.Ltmp17:
	#DEBUG_VALUE: fullAdder2:new_n14 <- $x5
	.loc	0 25 2                          # fulladder2.c:25:2
	#APP
	not	t0, t0
	#NO_APP
.Ltmp18:
	#DEBUG_VALUE: fullAdder2:new_n15 <- $x5
	.loc	0 26 2                          # fulladder2.c:26:2
	#APP
	and	t0, t0, t1
	#NO_APP
.Ltmp19:
	#DEBUG_VALUE: fullAdder2:new_n16 <- $x5
	.loc	0 27 2                          # fulladder2.c:27:2
	#APP
	not	t0, t0
	#NO_APP
.Ltmp20:
	#DEBUG_VALUE: fullAdder2:new_n17 <- $x5
	.loc	0 0 2 is_stmt 0                 # fulladder2.c:0:2
	sw	t0, 40(sp)                      # 4-byte Folded Spill
.Ltmp21:
	#DEBUG_VALUE: fullAdder2:new_n17 <- [DW_OP_plus_uconst 40] [$x2+0]
	#DEBUG_VALUE: fullAdder2:new_n17 <- [DW_OP_plus_uconst 40] [$x2+0]
	lw	t3, 20(sp)                      # 4-byte Folded Reload
.Ltmp22:
	#DEBUG_VALUE: fullAdder2:pi1 <- $x28
	lw	t2, 16(sp)                      # 4-byte Folded Reload
.Ltmp23:
	#DEBUG_VALUE: fullAdder2:pi3 <- $x7
	.loc	0 28 2 is_stmt 1                # fulladder2.c:28:2
	#APP
	xor	t1, t2, t3
	not	t1, t1
	#NO_APP
.Ltmp24:
	#DEBUG_VALUE: fullAdder2:new_n18 <- $x6
	.loc	0 0 2 is_stmt 0                 # fulladder2.c:0:2
	lw	t0, 40(sp)                      # 4-byte Folded Reload
.Ltmp25:
	#DEBUG_VALUE: fullAdder2:new_n17 <- $x5
	.loc	0 29 2 is_stmt 1                # fulladder2.c:29:2
	#APP
	xor	t0, t1, t0
	not	t0, t0
	#NO_APP
.Ltmp26:
	#DEBUG_VALUE: fullAdder2:po1 <- $x5
	#DEBUG_VALUE: fullAdder2:new_n17 <- [DW_OP_plus_uconst 40] [$x2+0]
	.loc	0 0 2 is_stmt 0                 # fulladder2.c:0:2
	sw	t0, 12(sp)                      # 4-byte Folded Spill
.Ltmp27:
	#DEBUG_VALUE: fullAdder2:po1 <- [DW_OP_plus_uconst 12] [$x2+0]
	#DEBUG_VALUE: fullAdder2:po1 <- [DW_OP_plus_uconst 12] [$x2+0]
	.loc	0 30 2 is_stmt 1                # fulladder2.c:30:2
	#APP
	and	t3, t2, t3
	#NO_APP
.Ltmp28:
	#DEBUG_VALUE: fullAdder2:new_n20 <- $x28
	.loc	0 31 2                          # fulladder2.c:31:2
	#APP
	not	t3, t3
	#NO_APP
.Ltmp29:
	#DEBUG_VALUE: fullAdder2:new_n21 <- $x28
	.loc	0 32 2                          # fulladder2.c:32:2
	#APP
	not	t1, t1
	#NO_APP
.Ltmp30:
	#DEBUG_VALUE: fullAdder2:new_n22 <- $x6
	.loc	0 0 2 is_stmt 0                 # fulladder2.c:0:2
	lw	t0, 40(sp)                      # 4-byte Folded Reload
.Ltmp31:
	#DEBUG_VALUE: fullAdder2:new_n17 <- $x5
	.loc	0 33 2 is_stmt 1                # fulladder2.c:33:2
	#APP
	and	t0, t1, t0
	#NO_APP
.Ltmp32:
	#DEBUG_VALUE: fullAdder2:new_n23 <- $x5
	.loc	0 34 2                          # fulladder2.c:34:2
	#APP
	not	t0, t0
	#NO_APP
.Ltmp33:
	#DEBUG_VALUE: fullAdder2:new_n24 <- $x5
	.loc	0 35 2                          # fulladder2.c:35:2
	#APP
	and	t0, t0, t3
	#NO_APP
.Ltmp34:
	#DEBUG_VALUE: fullAdder2:new_n25 <- $x5
	.loc	0 37 2                          # fulladder2.c:37:2
	#APP
	########## END ##########
	#NO_APP
	lw	a0, 28(sp)                      # 4-byte Folded Reload
.Ltmp35:
	#DEBUG_VALUE: fullAdder2:po0_p <- $x10
	.loc	0 0 2 is_stmt 0                 # fulladder2.c:0:2
	lw	a1, 24(sp)                      # 4-byte Folded Reload
.Ltmp36:
	#DEBUG_VALUE: fullAdder2:po0 <- $x11
	.loc	0 39 9 is_stmt 1                # fulladder2.c:39:9
	sw	a1, 0(a0)
	lw	a0, 32(sp)                      # 4-byte Folded Reload
.Ltmp37:
	#DEBUG_VALUE: fullAdder2:po1_p <- $x10
	.loc	0 0 9 is_stmt 0                 # fulladder2.c:0:9
	lw	a1, 12(sp)                      # 4-byte Folded Reload
.Ltmp38:
	#DEBUG_VALUE: fullAdder2:po1 <- $x11
	.loc	0 40 9 is_stmt 1                # fulladder2.c:40:9
	sw	a1, 0(a0)
	.loc	0 36 2                          # fulladder2.c:36:2
	#APP
	not	t0, t0
	#NO_APP
.Ltmp39:
	#DEBUG_VALUE: fullAdder2:po2 <- $x5
	.loc	0 0 2 is_stmt 0                 # fulladder2.c:0:2
	lw	a0, 36(sp)                      # 4-byte Folded Reload
.Ltmp40:
	#DEBUG_VALUE: fullAdder2:po2_p <- $x10
	.loc	0 41 9 is_stmt 1                # fulladder2.c:41:9
	sw	t0, 0(a0)
	...
	.loc	0 43 1 epilogue_begin           # fulladder2.c:43:1
	addi	sp, sp, 96
	ret
.Ltmp41:
.Lfunc_end0:
...
.Linfo_string1:
	.asciz	"fulladder2.c"                  # string offset=108
.Linfo_string2:
	.asciz	"/u/uab9qt/worktable/llvm_repos/bit-serial-compiler/step3-circuit-to-asm/2bit_full_adder" # string offset=121
.Linfo_string3:
	.asciz	"fullAdder2"                    # string offset=209
.Linfo_string4:
